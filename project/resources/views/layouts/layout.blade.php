          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span>Naufal M</span></li>
                  ...
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        ...
                        <ul class="nav navbar-nav">
                            <li><a href="" >Selamat Datang di Veterinarycare</a></li>
                                ...
                                <div class="panel box-v4">
                                    ...
                                    <div class="panel-body padding-0">
                                        <div class="col-md-12 col-xs-12 col-md-12 padding-0 box-v4-alert">
                                            <h2>Jadwal</h2>
                                            <p>Ini adalah jadwal yang dipesan</p>
                                   ...
                                   <p class="animated fadeInUp quote">Wahhh, Website ini sangat Membantu Sekali........."</p>
                                    <div class="col-md-12 padding-0">
                                      ...
                                      <div style="padding-top:8px;" class="text-right col-md-5 col-xs-12 col-sm-5 padding-0">
                                        <span class="fa fa-retweet"></span> 154
                                        <span class="fa fa-star"></span> 1897
                                      </div>
                                    </div>
                                </div>
                              </div>
