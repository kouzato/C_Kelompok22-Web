...
<div id="content" class="article-v1">
    <div class="panel box-shadow-none content-header">
        <div class="panel-body">
            <div class="col-md-12">
                <h3 class="animated fadeInLeft">Tentang Kami</h3>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="col-md-12  article-v1-body">
                    <p>&nbsp;
                        Perkembangan kemajuan teknologi menjadi salah satu alasan utama kami untuk menjadikan
                    ...
                    <p>
                        ...
                        peliharaan anda agar tetap sehat dan terawat dengan baik.
                    </p>
                </div>
